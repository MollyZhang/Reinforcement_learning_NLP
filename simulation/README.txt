The simulation is divide into 3 parts:
Initialization block:In this block I have initialised state variables:I have considered 4 state variables aand around 18 combinations of them
...
4)Whether the sentence is athe beginning or the end of the conversation

...
rate_table = pd.DataFrame([(0.2,0.18,0.16,0.14,0.12,0.1,0.08,0.06,0.04,0.02,0,0)],columns= turn_list)
...
for file in all_convs:
    with codecs.open("../Data/300_convo/" + file, 'r', 'utf-8') as f:
        ...
        try:
            ...
            print "Error"
'''
plt.plot(q_learning.q_table.ix['question answer short neg', 'negative'], 'r--')
plt.show()
